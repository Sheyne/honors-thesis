...
\textbf{TODO: Our description of Sinap on our website is fairly good, can 
...
\textbf{TODO: flow/edit the following}
...
\begin{mdframed}
\begin{align*}
\Type = &\LitT(\JSLit)   &\JSLit = &\operatorname{JSString} \\
&|\StringT                      &&| \operatorname{JSNumber} \\
&|\NumberT                      &&| \operatorname{true} \\
&|\BooleanT                     &&| \operatorname{false} \\
&|\RecT((\String, \Type), ...) & \JSTypeof(\operatorname{JSString}) &= \StringT \\
&|\ListT(\Type) & \JSTypeof(\operatorname{JSNumber}) &= \NumberT \\
&|\SetT(\Type) & \JSTypeof(\operatorname{true}) &= \BooleanT \\
&|\MapT(\Type, \Type) & \JSTypeof(\operatorname{false}) &= \BooleanT \\
...
\begin{align*}
    ...
    \ObjT_1 &\subtype \ObjT(\String_1, \_, \_) \stfif \ObjectSubtype(\String_1, \ObjT_1)\\
    \RecT_1&\subtype\RecT_2 \stfif \RecordSubtype(\RecT_1, \RecT_2) \\
...
\begin{align*}
    ...
    &| \ObjV((\Type)_1, V=((\String_1, \ValueRef_1]), ...)) \newlinewhere

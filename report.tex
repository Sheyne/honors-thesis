...
to adapt to best support the plugin that is currently loaded. 
...
contravariant approach to collection subtyping is widespread and 
used in languages such as Java. While it's technically not sound
when paired with mutation, it works well in practice. For 
the Sinap IDE use-case it doesn't come up. 
...
Sinap types is useful for generically describing data-structures so that 

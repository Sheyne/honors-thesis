...
and Standard ML \cite{Milner:1997:DSM:549659}. This is helpful because
it allows formal guarantees about the behavior of well-formed
programs. It is also useful because a model is often easier to 
...
and the conversion straightforward and is exemplified by 
...
\((\Kind_i)\). They are also equivalent to 
\((\Kind_1, ..., \Kind_n)\)

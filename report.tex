...
a lack of adequate tooling. If I were to invent a new text-based programming
language, I wouldn't first have to write a text editor. The problem is
that, until we created Sinap, if I was creating a graph based programming
language, I would first have to make a graph editor. Sinap IDE 
...
I was involved with the project as a whole, including architecting 
...
the application. However, my main focus was on the Type System. 
...
maps references to \(\Value\)s. I present a formal specification of
